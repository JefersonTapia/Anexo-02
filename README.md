...
<body>
    ...
    <div class="container mt-4">
        ...
        <!-- ✅ VERSIÓN SIN CUADRADOS REDONDEADOS -->
        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 5px;">
    ...
    <script>
        ...
        // ============================================
        // FUNCIÓN PRINCIPAL PARA GENERAR PDF - CORREGIDA
        // ============================================
        async function generarPDF() {
            ...
            const margin = 50; // Aumentado el margen
            let yPos = 50;
            let pageNumber = 1;
            ...
            function checkSpace(needed) {
                if (yPos + needed > pageHeight - 50) {
                    ...
                    // Opcional: Agregar número de página
                    pdf.setFontSize(8);
                    pdf.setTextColor(150, 150, 150);
                    pdf.text(`Página ${pageNumber}`, pageWidth - 60, pageHeight - 30);
                    return true;
                }
                return false;
            }
            ...
            pdf.setFontSize(9);
            pdf.text(`Generado: ${new Date().toLocaleString()}`, pageWidth - 140, 40);
            ...
            if (partes.length > 0) {
                ...
                // Verificar si las líneas caben en la página actual
    ...
    <!-- Si no tienes kit, usa esta versión gratuita -->
    <script src="https://use.fontawesome.com/releases/v6.0.0-beta3/js/all.js"></script>
</body>
</html>
